                        ...
                        <tr style={{ borderBottom: "1px solid var(--border)", background: "var(--cream)" }}>
                          <td colSpan={8} className="px-4 py-4 text-right">
                            <div className="flex flex-col gap-3 max-w-xl mr-0 ml-auto">
                              {/* Coupon */}
                              {order.couponCode && (
                                <p className="text-xs font-bold flex items-center gap-1.5 justify-end" style={{ color: "var(--green)" }}>
                                  קוד קופון: <span className="font-mono">{order.couponCode}</span>
                                  <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M20.59 13.41l-7.17 7.17a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>
                                </p>
                              )}
                              {/* Delivery details */}
